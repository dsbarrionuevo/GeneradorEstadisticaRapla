 ...
 * @author MatiasNB
 */
public class consultarHorasPorDia extends javax.swing.JFrame {

    /**
     * Creates new form consultarHorasPorDia
     */
    public consultarHorasPorDia() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tablaHorarios.setDefaultRenderer(String.class, new Render());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultarHorasPorDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultarHorasPorDia().setVisible(true);
            }
        });
    }
